...
export function MealDetail({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-ink/30 backdrop-blur-sm sm:items-center">
      <div className="glass flex max-h-[92vh] w-full max-w-lg flex-col overflow-y-auto rounded-t-3xl p-5 sm:rounded-3xl">
              ...
              <div className="mt-2 flex flex-col gap-2.5">
                ...
                {meal.manuallyEdited && (
                  <p className="mt-1 text-xs text-ink-faint">
                    Hinweis: Die Nährwerte oben wurden manuell angepasst — die Zutatenliste zeigt weiterhin
                    die ursprüngliche KI-Schätzung und summiert sich ggf. nicht mehr exakt darauf.
                  </p>
                )}
              </div>
            )}
