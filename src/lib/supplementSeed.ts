...
interface SeedSupplement {
  ...
  /** See Supplement.aliases in db.ts — only set where a real mismatch is likely (an English name, a common short form, an alternate spelling). */
  aliases?: string[]
}

const SEED: SeedSupplement[] = [
  // --- Muskelaufbau & Kraft ---
  { key: 'protein-powder', name: 'Proteinpulver', category: 'build_muscle', description: 'Deckt den Proteinbedarf, wenn er über die Ernährung allein schwer zu erreichen ist.', typicalDosage: '20–40 g, z.B. nach dem Training oder als Mahlzeitenergänzung', aliases: ['Eiweißpulver', 'Protein Shake'] },
  { key: 'whey-isolate', name: 'Whey-Isolat', category: 'build_muscle', description: 'Stärker gefiltertes Molkenprotein — sehr wenig Laktose und Fett, schnell verfügbar.', typicalDosage: '20–40 g pro Portion', aliases: ['Whey Protein', 'Whey'] },
  ...
  { key: 'creatine', name: 'Kreatin (Monohydrat)', category: 'build_muscle', description: 'Eines der am besten belegten Supps für Kraft- und Muskelaufbau — wirkt unabhängig vom Trainingstag.', typicalDosage: '3–5 g täglich, auch an trainingsfreien Tagen', aliases: ['Creatin', 'Kreatin Monohydrat'] },
  ...
  { key: 'l-carnitine', name: 'L-Carnitin', category: 'endurance', description: 'Rolle im Fettstoffwechsel; als Fatburner überschätzt, für die Erholung nach Belastung besser untersucht.', typicalDosage: '1–2 g täglich zu einer kohlenhydrathaltigen Mahlzeit', aliases: ['Carnitin'] },
  ...
  { key: 'l-theanine', name: 'L-Theanin', category: 'recovery', description: 'Aminosäure aus grünem Tee — fördert ruhige Wachheit ohne Müdigkeit.', typicalDosage: '100–200 mg bei Bedarf', aliases: ['Theanin'] },
  ...
  // --- Gelenke & Knochen ---
  { key: 'collagen', name: 'Kollagen', category: 'joints', description: 'Wird mit Gelenk-, Sehnen- und Hautgesundheit in Verbindung gebracht, besonders bei intensivem Training.', typicalDosage: '10–15 g täglich, idealerweise mit Vitamin C', aliases: ['Collagen'] },
  { key: 'collagen-uc2', name: 'Kollagen Typ II (UC-II)', category: 'joints', description: 'Undenaturiertes Kollagen in sehr kleiner Dosis — anderer Wirkmechanismus als Kollagen-Peptide.', typicalDosage: '40 mg täglich', aliases: ['Collagen Typ 2', 'UC-II'] },
  ...
  { key: 'calcium', name: 'Kalzium', category: 'joints', description: 'Wichtigster Knochenbaustein — relevant vor allem bei wenig Milchprodukten in der Ernährung.', typicalDosage: '500–1000 mg täglich, zu einer Mahlzeit', aliases: ['Calcium'] },
  ...
  // --- Immunsystem ---
  { key: 'vitamin-c', name: 'Vitamin C', category: 'immune', description: 'Antioxidans und Immunfaktor; verkürzt Erkältungen leicht, verhindert sie nicht.', typicalDosage: '200–1000 mg täglich', aliases: ['Ascorbinsäure'] },
  { key: 'vitamin-d3', name: 'Vitamin D3', category: 'immune', description: 'Besonders in den lichtärmeren Monaten oft eine sinnvolle Ergänzung.', typicalDosage: '1000–2000 IE täglich, zu einer fetthaltigen Mahlzeit', aliases: ['Vitamin D'] },
  { key: 'zinc', name: 'Zink', category: 'immune', description: 'Unterstützt Immunsystem und Hormonhaushalt.', typicalDosage: '15–25 mg täglich', aliases: ['Zinc'] },
  ...
  // --- Fokus & Kognition ---
  { key: 'l-tyrosine', name: 'L-Tyrosin', category: 'cognition', description: 'Vorstufe von Dopamin und Noradrenalin — untersucht für geistige Leistung unter Stress oder Schlafmangel.', typicalDosage: '500–2000 mg, 30–60 Min. vor Bedarf', aliases: ['Tyrosin'] },
  ...
  { key: 'l-glutamine', name: 'L-Glutamin', category: 'gut', description: 'Aminosäure, Hauptenergiequelle der Darmschleimhaut.', typicalDosage: '5 g täglich', aliases: ['Glutamin'] },
  ...
  { key: 'multivitamin', name: 'Multivitamin', category: 'general_health', description: 'Breite Grundabsicherung bei lückenhafter Mikronährstoffzufuhr.', typicalDosage: '1 Portion täglich zu einer Mahlzeit', aliases: ['Multivitamine', 'Multivitaminpräparat'] },
  { key: 'omega-3', name: 'Omega-3', category: 'general_health', description: 'Deckt EPA/DHA, wenn fetter Fisch selten auf dem Speiseplan steht.', typicalDosage: '1–2 g EPA/DHA täglich, zu einer Mahlzeit', aliases: ['Fischöl', 'Fischölkapseln'] },
  ...
  { key: 'vitamin-b12', name: 'Vitamin B12', category: 'general_health', description: 'Bei veganer oder stark fleischarmer Ernährung praktisch immer notwendig.', typicalDosage: '250 µg täglich oder 1000 µg mehrmals pro Woche', aliases: ['B12'] },
  { key: 'vitamin-b-complex', name: 'Vitamin-B-Komplex', category: 'general_health', description: 'Alle B-Vitamine gemeinsam — für Energiestoffwechsel und Nervensystem.', typicalDosage: '1 Kapsel täglich morgens', aliases: ['B-Komplex'] },
  { key: 'folate', name: 'Folsäure', category: 'general_health', description: 'Wichtig für Zellteilung und Blutbildung, besonders bei Kinderwunsch und in der Schwangerschaft.', typicalDosage: '400 µg täglich', aliases: ['Folat', 'Vitamin B9'] },
  ...
  { key: 'curcumin', name: 'Kurkuma (Curcumin)', category: 'general_health', description: 'Entzündungsmodulierend. Allein sehr schlecht verfügbar — auf Piperin oder eine Spezialformulierung achten.', typicalDosage: '500–1000 mg Curcumin täglich mit Piperin', aliases: ['Curcumin'] },
  { key: 'coq10', name: 'Coenzym Q10', category: 'general_health', description: 'Für die Energiegewinnung in den Mitochondrien; körpereigene Produktion sinkt mit dem Alter.', typicalDosage: '100–200 mg täglich zu einer fetthaltigen Mahlzeit', aliases: ['Q10', 'CoQ10', 'Ubiquinol'] },
  ...
  for (const seed of SEED) {
    ...
    if (match) {
      ...
      if (
        ...
        JSON.stringify(match.aliases ?? []) !== JSON.stringify(seed.aliases ?? [])
      ) {
        toUpdate.push({
          ...match,
