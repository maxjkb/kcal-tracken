...
const SEED: SeedSupplement[] = [
  ...
  { key: 'creatine', name: 'Kreatin (Monohydrat)', category: 'build_muscle', description: 'Eines der am besten belegten Supplements für Kraft- und Muskelaufbau — wirkt unabhängig vom Trainingstag.', typicalDosage: '3–5 g täglich, auch an trainingsfreien Tagen' },
