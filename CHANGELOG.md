...
- Die drei Kopf-Kacheln zeigen jetzt: links die Kalorienbilanz (schwarz/weiß im Defizit, rot bei Überschuss) mit einer zusätzlichen grauen Einordnung als Defizit/Erhaltung/Überschuss gegenüber dem tatsächlichen Kalorienbedarf; Mitte „Ø kcal/d"; rechts Protein/Kohlenhydrate/Fett nur noch als Icon mit Zahl, ohne Beschriftung.
...
- Die Feed-Tageszeiten-Kacheln bleiben jetzt so ein-/ausgeklappt, wie zuletzt eingestellt, statt sich bei jedem Seitenbesuch zurückzusetzen — ein neuer Tag startet eingeklappt.
